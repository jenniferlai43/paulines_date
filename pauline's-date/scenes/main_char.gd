...
func _physics_process(delta: float) -> void:
	var can_accept_input = not (game_manager.is_cutscene || game_manager.dialogue_is_active)
	...
	# Handle jump.
	if can_accept_input and Input.is_action_just_pressed("jump") and is_on_floor():
